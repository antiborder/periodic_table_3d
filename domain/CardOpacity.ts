...
class CardOpacity {
    ...
    getOpacity(): number {
        ...
        case characteristicValues["BOILING_POINT"]:
            opacity = elements[this.atomicNumber]["boilingPoint"] === null ? 0 : CardOpacity.DEFAULT_OPACITY;
            break;
        case characteristicValues["MELTING_POINT"]:
            opacity = elements[this.atomicNumber]["meltingPoint"] === null ? 0 : CardOpacity.DEFAULT_OPACITY;
            break;
        case characteristicValues["IONIZATION_ENERGY"]:
            opacity = elements[this.atomicNumber]["1stIonizationEnergy"] === null ? 0 : CardOpacity.DEFAULT_OPACITY;
            break;
        case characteristicValues["ELECTRON_AFFINITY"]:
            opacity = elements[this.atomicNumber]["electronAffinity"] === null ? 0 : CardOpacity.DEFAULT_OPACITY;
            break;
        default:
            opacity = CardOpacity.DEFAULT_OPACITY;
        }
