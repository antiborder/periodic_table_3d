...
const Element = ({ size = 0.4, radius = 0, color = '#000000', opacity = 1, ...props }:ElementProps): React.ReactNode => {
  ...
  //elements[props.atomicNumber.toString()]
  ...
  const getColor = () => {
      ...
      switch (tmp_number){ //(props.characteristicCount % props.numberOfCharacteristics) {
          case 0:
  ...
  const getTableBasePosition = (atomicNumber:Number):Num3 => {
      return [element.tableColumn, 0, -elements["1"].tableRow]//"atomicNumber.toString()"
  }
  ...
  const getTransition0to1Coordinate = (t: number): Num3 => {
      ...
      const translatedCoordinate: Num3 = [cartesianCoordinate[0], cartesianCoordinate[1] + (-Math.abs(t - 1) + 1) * distance, cartesianCoordinate[2]]
  ...
  const getTransition3to4Coordinate = (t: number): Num3 => {
      ...
      const translatedCoordinate: Num3 = [cartesianCoordinate[0], cartesianCoordinate[1] - (Math.abs(4-t)) * distance, cartesianCoordinate[2]]
      return translatedCoordinate
  }
  ...
  const getRotationAngle = (t: number): Num3 => {
      t = t % props.numberOfShapes
      if (t >= 0 && t <= 1) {
          const theta1 = getTheta1down()
  ...
  return (
    ...
    //   <animated.mesh {...props}
    //       position={getCoordinate(0)}//{transitionParameter.to(t => getCoordinate(t))}
    //       onPointerOver={() => handlePointerOver()}
    //       onPointerOut={() => handlePointerOut()}
    //       scale={scale}
    //       // onClick={handleElementClick}
    //       rotation={getRotationAngle(0)}//{transitionParameter.to(t => getRotationAngle(t))}
    ...
    //   >
        ...
        //   >
        //    <animated.mesh {...props}
        //       rotation={getTilt(0)}// {transitionParameter.to(t => getTilt(t))}
        //   >
          <mesh>
              <Quadrilateral {...props}
                  points={[
